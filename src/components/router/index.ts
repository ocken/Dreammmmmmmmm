...
import exceptionRoutes from '@/components/router/route.exception';
import asyncRoutes from '@/components/router/route.async';
import commonRoutes from '@/components/router/route.common';
