...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    Histroy: typeof import('./components/card/histroy.vue')['default']
    ...
    MyCard: typeof import('./components/card/my-card.vue')['default']
    OurHistroy: typeof import('./components/card/our-histroy.vue')['default']
